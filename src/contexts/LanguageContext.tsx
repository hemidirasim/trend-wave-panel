...
const translations: Record<string, Language> = {
  az: {
    ...
    'dashboard.balanceUpdated': 'Balansınız yeniləndi! Əlavə edildi',
  ...
  tr: {
    ...
    'dashboard.balanceUpdated': 'Bakiyeniz güncellendi! Eklendi',
  ...
  en: {
    ...
    'dashboard.balanceUpdated': 'Your balance has been updated! Added',
