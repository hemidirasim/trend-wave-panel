...
const translations: Record<string, Language> = {
  az: {
    ...
    'order.required': 'Lazım olan:',
    'order.available': 'Mövcud:',
  ...
  tr: {
    ...
    'login.signTitle': 'Kayıt Ol',
    'login.desc': 'Yeni bir hesap oluşturun',
    ...
    'order.servicePlace': 'Hizmet seçin ve siparişinizi verin',
    'order.required': 'Gereken:',
  ...
  en: {
    ...
    'login.desc': 'Create a new account',
    ...
    'order.servicePlace': 'Select a service and place your order',
