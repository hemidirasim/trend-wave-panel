...
const translations: Record<string, Language> = {
  ...
  en: {
    ...
    'blog.title': 'SMM Blog',
    'blog.subtitle': 'Latest articles about social media marketing, strategy and trends',
    'blog.latestTrends': 'Latest Trends',
    'blog.latestTrendsDesc': 'The newest trends and innovations in the social media world',
    'blog.practicalTips': 'Practical Tips',
    'blog.practicalTipsDesc': 'Effective strategies you can apply immediately',
    'blog.analytics': 'Analytics & Statistics',
    'blog.analyticsDesc': 'In-depth analysis and recommendations backed by numbers',
    'blog.readArticle': 'Read Article',
    'blog.backToBlog': 'Back to Blog',
    'blog.readOtherArticles': 'Read Other Articles',
