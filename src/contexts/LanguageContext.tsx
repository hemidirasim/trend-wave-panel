...
const translations: Record<string, Language> = {
  ...
  en: {
    ...
    'support.createTicketIfProblem': 'If you have a problem, create a new ticket',
    'support.errorFetchingTickets': 'Error occurred while loading tickets',
    'support.errorFetchingMessages': 'Error occurred while loading messages',
    ...
    'support.messageNotSent': 'Message could not be sent',
    ...
    'account.confirmPasswordPlaceholder': 'Re-enter the password',
  }
};
